...
const Filters =  ({setCurrentPage, setOrder}) => {
  ...
  const handleFilterCreated = (e) => {
    ...
    setCurrentPage(1);
    console.log( dispatch(filterCreated(e.target.value)));
  };
  ...
  const handleFilterType = (e) => {
    ...
    setCurrentPage(1);
     console.log( dispatch(filterType(e.target.value)) )
  };
  ...
  return ( 
    <div className={styles.div}>
      ...
      <div>
        ...
        <select className={styles.select} onChange={handleFilterStr}>
